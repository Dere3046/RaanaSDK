...
extern "C" {
    #[link_name = "rs_system_wq"]
    fn rs_system_wq() -> *mut bindings::workqueue_struct;
    #[link_name = "rs_system_highpri_wq"]
    fn rs_system_highpri_wq() -> *mut bindings::workqueue_struct;
    #[link_name = "rs_system_long_wq"]
    fn rs_system_long_wq() -> *mut bindings::workqueue_struct;
    #[link_name = "rs_system_unbound_wq"]
    fn rs_system_unbound_wq() -> *mut bindings::workqueue_struct;
    #[link_name = "rs_system_freezable_wq"]
    fn rs_system_freezable_wq() -> *mut bindings::workqueue_struct;
    #[link_name = "rs_system_power_efficient_wq"]
    fn rs_system_power_efficient_wq() -> *mut bindings::workqueue_struct;
    #[link_name = "rs_system_freezable_power_efficient_wq"]
    fn rs_system_freezable_power_efficient_wq() -> *mut bindings::workqueue_struct;
}
...
pub fn system() -> &'static Queue {
    ...
    unsafe { Queue::from_raw(rs_system_wq()) }
}
...
pub fn system_highpri() -> &'static Queue {
    ...
    unsafe { Queue::from_raw(rs_system_highpri_wq()) }
}
...
pub fn system_long() -> &'static Queue {
    ...
    unsafe { Queue::from_raw(rs_system_long_wq()) }
}
...
pub fn system_unbound() -> &'static Queue {
    ...
    unsafe { Queue::from_raw(rs_system_unbound_wq()) }
}
...
pub fn system_freezable() -> &'static Queue {
    ...
    unsafe { Queue::from_raw(rs_system_freezable_wq()) }
}
...
pub fn system_power_efficient() -> &'static Queue {
    ...
    unsafe { Queue::from_raw(rs_system_power_efficient_wq()) }
}
...
pub fn system_freezable_power_efficient() -> &'static Queue {
    ...
    unsafe { Queue::from_raw(rs_system_freezable_power_efficient_wq()) }
}
