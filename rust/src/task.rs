...
impl Task {
    ...
    pub fn group_leader(&self) -> &Task {
        ...
        let ptr = unsafe { bindings::rs_task_group_leader(self.as_ptr()) };
    ...
    pub fn pid(&self) -> Pid {
        ...
        // not a data race.
        unsafe { bindings::rs_task_pid(self.as_ptr()) }
    }
    ...
    pub fn policy(&self) -> u32 {
        ...
        // implemented.
        unsafe { bindings::rs_task_policy(self.0.get()) }
    }
    ...
    pub fn normal_prio(&self) -> i32 {
        ...
        // non-atomic unsynchronized writes. This corresponds to how the C macro READ_ONCE is
        // implemented.
        unsafe { bindings::rs_task_normal_prio(self.0.get()) }
    }
