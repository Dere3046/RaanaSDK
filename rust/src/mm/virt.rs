...
// Local FFI accessors for the opaque `vm_area_struct` fields.
extern "C" {
    #[link_name = "rs_vma_mm"]
    fn rs_vma_mm(vma: *mut bindings::vm_area_struct) -> *mut bindings::mm_struct;
    #[link_name = "rs_vma_flags"]
    fn rs_vma_flags(vma: *mut bindings::vm_area_struct) -> bindings::vm_flags_t;
    #[link_name = "rs_vma_start"]
    fn rs_vma_start(vma: *mut bindings::vm_area_struct) -> usize;
    #[link_name = "rs_vma_end"]
    fn rs_vma_end(vma: *mut bindings::vm_area_struct) -> usize;
    #[link_name = "rs_vma_set_flags"]
    fn rs_vma_set_flags(vma: *mut bindings::vm_area_struct, flags: bindings::vm_flags_t);
}
...
impl VmaRef {
    ...
    pub fn mm(&self) -> &MmWithUser {
        ...
        // `mm_users`.
        unsafe { MmWithUser::from_raw(rs_vma_mm(self.as_ptr())) }
    }
    ...
    pub fn flags(&self) -> vm_flags_t {
        ...
        unsafe { rs_vma_flags(self.as_ptr()) }
    }
    ...
    pub fn start(&self) -> usize {
        // SAFETY: By the type invariants, the caller holds at least the mmap read lock, so this
        // access is not a data race.
        unsafe { rs_vma_start(self.as_ptr()) }
    }
...
impl VmaNew {
    ...
    unsafe fn update_flags(&self, set: vm_flags_t, unset: vm_flags_t) {
        ...
        unsafe { rs_vma_set_flags(self.as_ptr(), flags) };
    }
