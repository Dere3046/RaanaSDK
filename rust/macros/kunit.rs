...
pub(crate) fn kunit_tests(attr: TokenStream, ts: TokenStream) -> TokenStream {
    ...
    //
    // static mut TEST_CASES: [kernel::kunit::KUnitCaseMeta; 3] = [
    //     kernel::kunit::KUnitCaseMeta::new(kernel::c_str!("foo").as_char_ptr(), kunit_rust_wrapper_foo),
    //     kernel::kunit::KUnitCaseMeta::new(kernel::c_str!("bar").as_char_ptr(), kunit_rust_wrapper_bar),
    //     kernel::kunit::KUnitCaseMeta::null(),
    // ];
    //
    // kernel::kunit_unsafe_test_suite!(kunit_test_suit_name, TEST_CASES, 3);
    // ```
    ...
    for test in &tests {
        ...
        writeln!(
            test_cases,
            "    kernel::kunit::KUnitCaseMeta::new(kernel::c_str!(\"{}\").as_char_ptr(), {}),",
    ...
    writeln!(
        kunit_macros,
        "static mut TEST_CASES: [kernel::kunit::KUnitCaseMeta; {}] = [\n{test_cases}    kernel::kunit::KUnitCaseMeta::null(),\n];",
        tests.len() + 1
    )
    .unwrap();
